...
export const metadata: Metadata = {
  ...
  title: '콘센트온 - 최저가 항공권 검색',
  description: '일본, 유럽, 동남아 최저가 항공권을 한눈에! 월별 최저가 자동 업데이트. 직항/경유 필터링, 가격 비교로 쉽고 빠른 항공권 검색.',
  keywords: ['항공권', '최저가', '항공권 검색', '여행', '일본 항공권', '유럽 항공권', '동남아 항공권', '직항', '스카이스캐너', '항공권 비교', '콘센트온'],
  authors: [{ name: 'ConcentOn' }],
  creator: 'ConcentOn',
  publisher: 'ConcentOn',
  ...
  verification: {
    google: 'K3xfstQLxy9V2iSL-sDWvnQe3-z0vKzsNzw2drOCz7I',
    other: {
      'naver-site-verification': '1e0ff7b5501632a35d472b6566a853d359e1d520',
    },
  },
}
